...
describe("Añadir Fecha Límite a Tarea", () => {
    ...
    it("deberia poder crear tarea con fecha limite", () => {
        var tarea = new Tarea("ir a piscina","nadar 50 minutos","tarea-1","","2024-11-07T13:29");
        expect(tarea.getFechaLimite()).toEqual(new Date("2024-11-07T13:29"));
    }); 
    it("deberia poder crear tarea con fecha limite", () => {
        var tarea = new Tarea("ir a piscina","nadar 50 minutos","tarea-1","","2024-08-07T23:29");
        expect(tarea.getFechaLimite()).toEqual(new Date("2024-08-07T23:29"));
    }); 
    ...
    it("deberia agregar tareas con fecha limite a la lista", () => {     
        ...
        listaTareas.agregarTarea("ir a piscina","nadar 50 minutos","","2024-08-07T23:29");
        expect(listaTareas.getCantidadTareas()).toEqual(1);
    }); 
    it("deberia agregar tareas con fecha limite a la lista", () => {     
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("ir a piscina","nadar 50 minutos","","2024-08-07T23:29");
        listaTareas.agregarTarea("ir a correr","correr 50 minutos","","2024-08-07T23:29");
    ...
    it("deberia agregar tareas con y sin fecha limite a la lista", () => {     
        ...
        listaTareas.agregarTarea("ir a piscina","nadar 50 minutos");
        listaTareas.agregarTarea("ir a correr","correr 50 minutos");
        listaTareas.agregarTarea("tarea de mate","ejercicios suma","","2024-08-07T23:29");
        expect(listaTareas.getCantidadTareas()).toEqual(3);
    }); 
    ...
    it("deberia poder devolver lista de fecha limites de las tareas agregadas a la lista", () => {     
        ...
        listaTareas.agregarTarea("ir a correr","correr 50 minutos");
        listaTareas.agregarTarea("tarea de mate","ejercicios suma","","2024-08-07T23:29");       
        expect(listaTareas.getFechaLimiteTareas()).toEqual([null,null,new Date("2024-08-07T23:29")]);
    }); 
    it("deberia poder devolver lista de fecha limites de las tareas agregadas a la lista", () => {     
        var listaTareas = new ListaTareas();        
        ...
        listaTareas.agregarTarea("ir a correr","correr 50 minutos");
        listaTareas.agregarTarea("tarea de mate","ejercicios suma","","2024-08-07T23:29");
        expect(listaTareas.getFechaLimiteTareas()).toEqual([new Date("2023-10-09T23:29"),null,new Date("2024-08-07T23:29")]);
    }); 
    it("deberia poder devolver lista de fecha limites de las tareas agregadas a la lista", () => {     
        var listaTareas = new ListaTareas();        
        listaTareas.agregarTarea("ir a piscina","nadar 50 minutos","","2023-10-09T23:29");
        ...
        listaTareas.agregarTarea("tarea de mate","ejercicios suma","","2024-08-07T23:29");
        expect(listaTareas.getFechaLimiteTareas()).toEqual([new Date("2023-10-09T23:29"),new Date("2024-03-19T20:29"),new Date("2024-08-07T23:29")]);
    });
    //CC2
    ...
    it("se deberia ver la fecha limite de un tarea a partir de un id", () => {
        var listaTareas = new ListaTareas();      
        listaTareas.agregarTarea("tarea1","tarea de fisica","","2023-10-09T23:29");
        listaTareas.agregarTarea("tarea2","tarea de mate","","2024-06-09T23:29");
        var tarea = listaTareas.getTareaPorId("tarea-2"); 
        expect(tarea.getFechaLimite()).toEqual(new Date("2024-06-09T23:29"));
    });
    ...
    it("se deberia ver fecha limite null si se busca de un id que no existe en la lista", () => {
        var listaTareas = new ListaTareas();      
        listaTareas.agregarTarea("tarea1","tarea de fisica","","2024-06-09T23:29");
    ...
    it("deberia controlar si tarea tiene fecha pasada", () => {          
        var tarea = new Tarea("tarea1","tarea de fisica","tarea-1","","2024-06-09T23:29");      
    ...
    it("no deberia agregar tarea con fecha pasada a la lista", () => {
        ...
        listaTareas.agregarTarea("tarea1","tarea de fisica","","1999-01-18T23:29");   
        listaTareas.agregarTarea("tarea2","tarea de fisica","","2025-01-18T23:29");   
        listaTareas.agregarTarea("tarea3","tarea de fisica","","2024-01-18T23:29");      
        expect(listaTareas.getCantidadTareas()).toEqual(2);
    });
    it("no deberia agregar tarea con fecha pasada a la lista", () => {
        var listaTareas = new ListaTareas();   
