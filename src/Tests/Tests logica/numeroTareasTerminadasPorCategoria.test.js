...
describe("Numero de tareas por categoria", () => {  
    ...
    it("Deberia devolver estadisticas de tareas terminadas correspondientes a una categoria y UNA fecha 1", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-12-07T23:59")
        var tarea =  listaTareas.getTareaPorId("tarea-1").terminar();  
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-12-07T23:59","2024-12-07T23:59")).toEqual({"Sin categoria":[1,"100%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[0,"0%"]});
    });

    it("Deberia devolver estadisticas de tareas terminadas correspondientes a una categoria y UNA fecha 2", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-10-07T23:59")
        var tarea =  listaTareas.getTareaPorId("tarea-1").terminar();  
        
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-12-07T23:59","2024-12-07T23:59")).toEqual({"Sin categoria":[0,"0%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[0,"0%"]});
    });

    it("Deberia devolver estadisticas de tareas terminadas correspondientes a una categoria y un rango de fechas ", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-10-07T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-11-07T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-12-07T23:59")
        listaTareas.getTareaPorId("tarea-1").terminar();
        listaTareas.getTareaPorId("tarea-2").terminar(); 
        listaTareas.getTareaPorId("tarea-3").terminar();   
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-10-01T23:59","2024-12-30T23:59")).toEqual({"Sin categoria":[3,"100%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[0,"0%"]});
    });
    it("Deberia devolver estadisticas de tareas terminadas correspondientes a una categoria y un rango de fechas ", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-10-07T23:59")
        ...
        listaTareas.getTareaPorId("tarea-2").terminar();
        listaTareas.getTareaPorId("tarea-3").terminar();         
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-10-01T23:59","2024-11-30T23:59")).toEqual({"Sin categoria":[2,"100%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[0,"0%"]});
    });
    it("Deberia devolver estadisticas de tareas terminadas correspondientes a una categoria y un rango de fechas ", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-1-07T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-2-07T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-3-07T23:59")
        listaTareas.getTareaPorId("tarea-1").terminar();
        listaTareas.getTareaPorId("tarea-2").terminar();
        listaTareas.getTareaPorId("tarea-3").terminar();         
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-10-01T23:59","2024-11-30T23:59")).toEqual({"Sin categoria":[0,"0%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[0,"0%"]});
    });
    it("Si no esta en un rango de fechas solicitadas, no deberia mostrar ninguna tarea terminada", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Personal","2024-01-01T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Trabajo","2024-02-01T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-03-01T23:59")
        listaTareas.getTareaPorId("tarea-1").terminar();
        listaTareas.getTareaPorId("tarea-2").terminar();
        listaTareas.getTareaPorId("tarea-3").terminar();         
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-10-01T23:59","2024-11-30T23:59")).toEqual({"Sin categoria":[0,"0%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[0,"0%"]});
    ...
    it("El porcentaje de las estadísticas debe estar acorde a los rangos de fecha", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-01-15T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-02-14T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-03-20T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-04-22T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-05-30T23:59")
        listaTareas.getTareaPorId("tarea-1").terminar();
        listaTareas.getTareaPorId("tarea-2").terminar();
        listaTareas.getTareaPorId("tarea-3").terminar();
        listaTareas.getTareaPorId("tarea-4").terminar();
        listaTareas.getTareaPorId("tarea-5").terminar();         
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-01-01T23:59","2024-03-30T23:59")).toEqual({"Sin categoria":[0,"0%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[3,"100%"]});
    });
    it("El porcentaje de las estadísticas debe estar acorde a los rangos de fecha", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-01-15T23:59")
        ...
        listaTareas.getTareaPorId("tarea-4").terminar();
        listaTareas.getTareaPorId("tarea-5").terminar();         
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-01-01T23:59","2024-03-30T23:59")).toEqual({"Sin categoria":[0,"0%"],"Personal":[0,"0%"],"Trabajo":[0,"0%"],"Estudio":[1,"33%"]});
    });
    it("El porcentaje de las estadísticas debe estar acorde a los rangos de fecha", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-01-15T23:59")
    ...
    it("El porcentaje de las estadísticas debe estar acorde a los rangos de fecha", () => {
        var listaTareas = new ListaTareas(); 
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2024-01-15T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Sin categoria","2020-01-14T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Personal","2024-01-20T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Personal","2020-01-22T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Trabajo","2024-01-30T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Trabajo","2020-01-30T23:59")
        listaTareas.agregarTarea("cumpleaños amiga","","Estudio","2024-01-30T23:59")
        ...
        expect(  listaTareas.tareasTerminadasPorCategoria_PorRangoDeFecha("2024-01-01T23:59","2024-03-30T23:59")).toEqual({"Sin categoria":[1,"100%"],"Personal":[1,"100%"],"Trabajo":[1,"100%"],"Estudio":[1,"100%"]});
    });
